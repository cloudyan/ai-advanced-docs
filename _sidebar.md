...
- [概览](05-transformer/README)
- [注意力机制详解](05-transformer/attention-mechanism)
- 位置编码（待补充）
- 编码器 - 解码器（待补充）
...
- [概览](09-advanced-architecture/README)
- MoE 混合专家（待补充）
- 多模态模型（待补充）
- 世界模型（待补充）
...
- [AI 数学基础](https://cloudyan.github.io/ai-math-docs/) - 前置课程
- [AI 专家路线图](../memory/ai-expert-roadmap.md)
- [知识关联图](../memory/ai-knowledge-connections.md)
- [项目案例](../memory/ai-projects-blog.md)
